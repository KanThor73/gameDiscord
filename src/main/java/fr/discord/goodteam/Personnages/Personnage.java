...
import fr.discord.goodteam.Exceptions.NullStackException;
...
public class Personnage {
	...
	public void boire(PotionVie pot) {
		if (estVivant()) {
			try {
				updatePV(-pot.use());
				System.out.println(nom + " boit une potion de vie");
			} catch (NullStackException e) {
				System.out.println(nom + " essaye de boire une potion inexistante");
			}
			catch (Exception e) {
				System.out.println("Imprévu : " + e.getMessage());
			}
		} else {
